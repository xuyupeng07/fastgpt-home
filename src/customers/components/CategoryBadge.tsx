...
export default function CategoryBadge({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`relative z-50 inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-[13px] font-bold transition-all cursor-pointer ${className}`.trim()}
      style={{
        color: categoryColor,
